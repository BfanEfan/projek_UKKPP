...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `role` enum('ADMIN','BK','WALI_KELAS','GURU') NOT NULL DEFAULT 'GURU',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_admin`),
  UNIQUE KEY `username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table db_ukkpp_new.admin: ~5 rows (approximately)
DELETE FROM `admin`;
...
INSERT INTO `m_siswa` (`id_siswa`, `nipd`, `nama_siswa`, `kelas`, `jurusan`, `creat_at`) VALUES
	...
	(5, '2334107', 'noval', '12', 'DKV', '2026-04-15 07:38:37'),
	(6, '2334108', 'Uki', '11', 'DKV', NULL);
...
-- Dumping data for table db_ukkpp_new.pelanggaran_siswa: ~7 rows (approximately)
...
CREATE TABLE `v_detail_pelanggaran` (
	...
	`role` ENUM('ADMIN','BK','WALI_KELAS','GURU') NOT NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
